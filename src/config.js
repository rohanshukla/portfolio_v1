module.exports = {
  ...
  siteKeywords:
    'Rohan Shukla, Rohan, Shukla, rohanshukla, shuklarohan, software engineer, application engineer, full-stack engineer, mern stack, web developer, javascript, mumbai, india',
